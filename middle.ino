...
// Configuration:
#define WIFI_NAME       "NODE3"      // Your WiFi AP.
#define WIFI_PASSWORD   "sau100008"  // Your WiFi AP password.
#define PI_IP_ADDRESS   "192.168.0.40"      // IP address of the listening Pi.
#define NAME            "NODEMCU BOARD 2: ----- "       // Name of the device, written as the
                                            // first CSV value.
#define PI_PORT         5040                // Port for the listening Pi.
